...
import { EnderecoClienteValidation, NumberValidation, EnderecoValidation } from "../Validations/Validations"
...
class EnderecoController {
    async adicionarEndereco(request: Request, response: Response){
        ...
        try {
            ...
            const { error } = EnderecoClienteValidation.validate(endereco);
